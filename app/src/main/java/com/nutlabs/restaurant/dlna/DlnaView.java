package com.nutlabs.restaurant.dlna;
...
import com.nutlabs.restaurant.MainActivityNew;
import com.nutlabs.restaurant.R;

import java.util.ArrayList;

public class DlnaView extends ListActivity
                          implements com.nutlabs.restaurant.dlna.ContentDirectoryBrowseTaskFragment.Callbacks,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_refresh:
                ...
                //mFragment.refreshCurrent();
                Intent intent = new Intent(DlnaView.this, MainActivityNew.class);
