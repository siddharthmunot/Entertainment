 ...
 */
package com.nutlabs.restaurant.kore.host;

import android.os.Handler;

import com.nutlabs.restaurant.kore.jsonrpc.ApiCallback;
import com.nutlabs.restaurant.kore.jsonrpc.HostConnection;
import com.nutlabs.restaurant.kore.jsonrpc.method.JSONRPC;
import com.nutlabs.restaurant.kore.jsonrpc.method.Player;
import com.nutlabs.restaurant.kore.jsonrpc.notification.Input;
import com.nutlabs.restaurant.kore.jsonrpc.type.ListType;
import com.nutlabs.restaurant.kore.jsonrpc.type.PlayerType;
import com.nutlabs.restaurant.kore.jsonrpc.notification.System;
...
public class HostConnectionObserver
    ...
    public interface PlayerEventsObserver {
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently playing item, obtained by a call to {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetItem}
         */
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently paused item, obtained by a call to {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetItem}
         */
...
//        observerHandlerMap.remove(observer);
     ...
     */
    public void onPlay(com.nutlabs.restaurant.kore.jsonrpc.notification.Player.OnPlay notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onPause(com.nutlabs.restaurant.kore.jsonrpc.notification.Player.OnPause
                                notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onSpeedChanged(com.nutlabs.restaurant.kore.jsonrpc.notification.Player
                                       .OnSpeedChanged notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onSeek(com.nutlabs.restaurant.kore.jsonrpc.notification.Player.OnSeek notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onStop(com.nutlabs.restaurant.kore.jsonrpc.notification.Player.OnStop notification) {
        // Just start our chain calls
