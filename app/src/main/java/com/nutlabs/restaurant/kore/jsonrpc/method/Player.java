 ...
 */
package com.nutlabs.restaurant.kore.jsonrpc.method;
...
import com.nutlabs.restaurant.kore.utils.JsonUtils;
...
public class Player {
        ...
        public ArrayList<PlayerType.GetActivePlayersReturnType> resultFromJson(ObjectNode jsonObject) throws ApiException {
            ...
            if (resultNode != null) {
                for (JsonNode node : resultNode) {
                    res.add(new PlayerType.GetActivePlayersReturnType(node));
                }
            }
            return res;
        }
    ...
    public static final class SetSpeed extends ApiMethod<Integer> {
         ...
         * Set the speed of the current playback
         * @param playerId Player id for which to toggle the state
         * @param speed String enum in {@link com.nutlabs.restaurant.kore.jsonrpc.type.GlobalType.IncrementDecrement}
         */
    ...
    public static final class SetRepeat extends ApiMethod<String> {
         ...
         * Set the repeat mode of the player
         * @param playerId Player id for which to stop playback
         * @param repeat Repeat mode, see {@link com.nutlabs.restaurant.kore.jsonrpc.type.PlayerType.Repeat}
         */
