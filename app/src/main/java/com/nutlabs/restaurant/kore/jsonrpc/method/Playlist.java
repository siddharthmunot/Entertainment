...
import com.nutlabs.restaurant.kore.jsonrpc.type.PlaylistType.GetPlaylistsReturnType;
...
public class Playlist {
    ...
    public static final class GetPlaylists extends ApiMethod<ArrayList<GetPlaylistsReturnType>> {
        ...
        @Override
        public ArrayList<PlaylistType.GetPlaylistsReturnType> resultFromJson(ObjectNode jsonObject) throws ApiException {
            ArrayNode resultNode = (ArrayNode)jsonObject.get(RESULT_NODE);
            ArrayList<PlaylistType.GetPlaylistsReturnType> res = new ArrayList<PlaylistType.GetPlaylistsReturnType>();
            if (resultNode != null) {
                for (JsonNode node : resultNode) {
                    res.add(new PlaylistType.GetPlaylistsReturnType(node));
                }
            }
            return res;
        }
