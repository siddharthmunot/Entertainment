...
public class VideoLibrary {
    ...
    public static class GetMovies extends ApiMethod<List<VideoType.DetailsMovie>> {
         ...
         *
         * @param limits Limits to retrieve. See {@link com.nutlabs.restaurant.kore.jsonrpc.type.ListType.Limits}
         * @param properties Properties to retrieve. See {@link VideoType.FieldsMovie} for a list of
         *                   accepted values
         */
    ...
    public static class GetGenres extends ApiMethod<List<LibraryType.DetailsGenre>> {
        ...
        public final static String METHOD_NAME = "VideoLibrary.GetGenres";
