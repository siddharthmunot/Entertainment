 ...
 */
package com.nutlabs.restaurant.kore.provider;
...
public class MediaContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.nutlabs.restaurant.kore.provider";
    ...
    public static final String PATH_VIDEO_GENRES = "video_genres";
    ...
    public static class Hosts implements BaseColumns, SyncColumns, HostsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_HOSTS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_HOSTS;
    ...
    public static class Movies implements BaseColumns, SyncColumns, MoviesColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_MOVIES;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_MOVIES;
        ...
        public final static String[] ALL_COLUMNS = {
                ...
                TOP250, TRAILER, VOTES, WRITERS, YEAR, DATEADDED,TAG
        };
    }
    ...
    public static class MovieCast implements BaseColumns, SyncColumns, MovieCastColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_MOVIE_CAST;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_MOVIE_CAST;
    ...
    public static class TVShows implements BaseColumns, SyncColumns, TVShowsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_TVSHOWS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_TVSHOWS;
    ...
    public static class TVShowCast implements BaseColumns, SyncColumns, TVShowCastColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_TVSHOW_CAST;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_TVSHOW_CAST;
    ...
    public static class Seasons implements BaseColumns, SyncColumns, SeasonsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_SEASONS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_SEASONS;
    ...
    public static class Episodes implements BaseColumns, SyncColumns, EpisodesColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_EPISODES;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_EPISODES;
    ...
    public static class Artists implements BaseColumns, SyncColumns, ArtistsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_ARTISTS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_ARTISTS;
    ...
    public static class Albums implements BaseColumns, SyncColumns, AlbumsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_ALBUMS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_ALBUMS;
    ...
    public static class Songs implements BaseColumns, SyncColumns, SongsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_SONGS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_SONGS;
    ...
    public static class AudioGenres implements BaseColumns, SyncColumns, AudioGenresColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_AUDIO_GENRES;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_AUDIO_GENRES;
    ...
    /**
     * Columns for VideoGenres table
     * For XBMC reference/unique key use HOST_ID + GENREID
     */
    public interface VideoGenresColumns {
        String HOST_ID = "host_id";
        String GENREID = "genreid";
    ...
    public static class VideoGenres implements BaseColumns, SyncColumns, VideoGenresColumns {
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_VIDEO_GENRES).build();

        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_VIDEO_GENRES;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_VIDEO_GENRES;

        /** Build {@link Uri} for genres list. */
        public static Uri buildVideoGenresListUri(long hostId) {
            return Hosts.buildHostUri(hostId).buildUpon()
                    .appendPath(PATH_VIDEO_GENRES)
                    .build();
        }

        /** Build {@link Uri} for requested {@link #_ID}. */
        public static Uri buildVideoGenreUri(long hostId, long genreId) {
            return Hosts.buildHostUri(hostId).buildUpon()
                    .appendPath(PATH_VIDEO_GENRES)
                    .appendPath(String.valueOf(genreId))
                    .build();
        ...
        /** Read {@link #_ID} from {@link Albums} {@link Uri}. */
        public static String getVideoGenreId(Uri uri) {
            return uri.getPathSegments().get(3);
        }
    ...
    public static class AlbumArtists implements BaseColumns, AlbumArtistsColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_ALBUM_ARTISTS;
    ...
    public static class AlbumGenres implements BaseColumns, AlbumGenresColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_ALBUM_GENRES;
    ...
    /**
     * Columns for MovieGenres table
     * For XBMC reference/unique key use HOST_ID + GENREID
     */
    public interface MovieGenresColumns {
        String HOST_ID = "host_id";
        String GENREID = "genreid";
    ...
    public static class MovieGenres implements BaseColumns, SyncColumns, MovieGenresColumns {
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_MOVIE_GENRES).build();
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_MOVIE_GENRES;

        /** Build {@link Uri} for requested {@link #_ID}. */
        public static Uri buildMovieForGenreListUri(long hostId, long genreId) {
            return Hosts.buildHostUri(hostId).buildUpon()
                    .appendPath(PATH_MOVIE_GENRES)
                    .appendPath(String.valueOf(genreId))
                    .appendPath(PATH_MOVIES)
                    .build();
        }
    ...
    public static class MusicVideos implements BaseColumns, SyncColumns, MusicVideosColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.com.nutlabs.restaurant." + PATH_MUSIC_VIDEOS;
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.com.nutlabs.restaurant." + PATH_MUSIC_VIDEOS;
