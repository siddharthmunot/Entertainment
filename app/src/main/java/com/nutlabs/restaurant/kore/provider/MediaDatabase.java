...
public class MediaDatabase extends SQLiteOpenHelper {
	...
	public interface Tables {
        ...
        String VIDEO_GENRES = "video_genres";
        ...
        String MOVIE_GENRES_NEW = "movie_genres_new";
        /**
        ...
        /**
         * Join to get Movie for a Genre
         */
        String MOVIES_FOR_GENRE_JOIN =
                MOVIE_GENRES + " JOIN " + MOVIES + " ON " +
                        MOVIE_GENRES + "." + MediaContract.MovieGenres.HOST_ID + "=" + MOVIES + "." + MediaContract.Movies.HOST_ID +
                        " AND " +
                        MOVIE_GENRES + "." + MediaContract.MovieGenres.MOVIE_ID + "=" + MOVIES + "." + MediaContract.Movies.MOVIEID;
         ...
         * Join to get Movie for a Genre
         */
        String MOVIES_FOR_GENRE_JOIN_NEW =
                MOVIE_GENRES_NEW + " JOIN " + MOVIES + " ON " +
                        MOVIE_GENRES_NEW + "." + MediaContract.MovieGenres.HOST_ID + "=" + MOVIES + "." + MediaContract.Movies.HOST_ID +
                        " AND " +
                        MOVIE_GENRES_NEW + "." + MediaContract.MovieGenres.MOVIE_ID + "=" + MOVIES + "." + MediaContract.Movies.MOVIEID;
        ...
        /**
         * Join to get Genres for an Movie
         */
        String GENRES_FOR_MOVIE_JOIN =
                MOVIE_GENRES + " JOIN " + VIDEO_GENRES + " ON " +
                        MOVIE_GENRES + "." + MediaContract.MovieGenres.HOST_ID + "=" + VIDEO_GENRES + "." + MediaContract.VideoGenres.HOST_ID +
                        " AND " +
                        MOVIE_GENRES + "." + MediaContract.MovieGenres.GENREID + "=" + VIDEO_GENRES + "." + MediaContract.VideoGenres.GENREID;

        /**
         * Join to get Genres for an Album
         */
        String GENRES_FOR_MOVIE_JOIN_NEW =
                MOVIE_GENRES_NEW + " JOIN " + VIDEO_GENRES + " ON " +
                        MOVIE_GENRES_NEW + "." + MediaContract.MovieGenres.HOST_ID + "=" + VIDEO_GENRES + "." + MediaContract.VideoGenres.HOST_ID +
                        " AND " +
                        MOVIE_GENRES_NEW + "." + MediaContract.MovieGenres.GENREID + "=" + VIDEO_GENRES + "." + MediaContract.VideoGenres.GENREID;
    ...
    private interface References {
        ...
        String MOVIE_MOVIEID =
                "REFERENCES " + Tables.MOVIES + "(" + MediaContract.MoviesColumns.MOVIEID + ")";

        String MOVIE_GENREID =
                "REFERENCES " + Tables.MOVIE_GENRES + "(" + MediaContract.MovieGenresColumns.GENREID + ")";
    }
	...
	public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.MOVIES + "(" +
                   ...
                   MediaContract.MoviesColumns.TAG + " TEXT, " +
        ...
        // VideoGenres
        db.execSQL("CREATE TABLE " + Tables.VIDEO_GENRES + "(" +
                        BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        MediaContract.SyncColumns.UPDATED + " INTEGER NOT NULL," +
                        MediaContract.VideoGenresColumns.HOST_ID + " INTEGER NOT NULL " + References.HOST_ID + ", " +
                        MediaContract.VideoGenresColumns.GENREID + " INTEGER NOT NULL, " +
                        MediaContract.VideoGenresColumns.THUMBNAIL + " TEXT, " +
                        MediaContract.VideoGenresColumns.TITLE + " TEXT, " +
                        "UNIQUE (" +
                        MediaContract.AudioGenresColumns.HOST_ID + ", " +
                        MediaContract.AudioGenresColumns.GENREID +
                        ") ON CONFLICT REPLACE)"
        ...
        db.execSQL("CREATE TABLE " + Tables.MOVIE_GENRES + "(" +
                        BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        MediaContract.MovieGenresColumns.HOST_ID + " INTEGER NOT NULL " + References.HOST_ID + ", " +
                        MediaContract.MovieGenresColumns.MOVIE_ID + " INTEGER NOT NULL " + References.MOVIE_MOVIEID + ", " +
                        MediaContract.MovieGenresColumns.GENREID + " INTEGER NOT NULL " + References.MOVIE_GENREID + ", " +
                        "UNIQUE (" +
                        MediaContract.MovieGenresColumns.HOST_ID + ", " +
                        MediaContract.MovieGenresColumns.MOVIE_ID + ", " +
                        MediaContract.MovieGenresColumns.GENREID +
                        ") ON CONFLICT REPLACE)"
        );
        ...
        db.execSQL(buildHostsDeleteTrigger(Tables.VIDEO_GENRES, MediaContract.VideoGenresColumns.HOST_ID));
        ...
        db.execSQL(buildHostsDeleteTrigger(Tables.MOVIE_GENRES, MediaContract.MovieGenresColumns.HOST_ID));
    }
    ...
    private void resetDb(SQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + Tables.VIDEO_GENRES);
        ...
        db.execSQL("DROP TABLE IF EXISTS " + Tables.MOVIE_GENRES);
		onCreate(db);
    }
