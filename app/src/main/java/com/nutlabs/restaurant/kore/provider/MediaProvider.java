...
import com.nutlabs.restaurant.kore.utils.SelectionBuilder;
...
public class MediaProvider extends ContentProvider {
    ...
    private static final int MOVIES_GENRES_LIST = 203;
    private static final int MOVIES_GENRES_ALL = 204;
    ...
    private static final int VIDEO_GENRES_ALL = 920;
    private static final int VIDEO_GENRES_LIST = 921;
    private static final int VIDEO_GENRES_ID = 922;
    private static final int VIDEO_GENRE_MOVIES_LIST = 930;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // Movies and cast and movie genre
        ...
        matcher.addURI(authority, MediaContract.PATH_HOSTS + "/*/" +
                ...
                MediaContract.PATH_VIDEO_GENRES, MOVIES_GENRES_LIST);
        ...
        // Movies Genres
        matcher.addURI(authority, MediaContract.PATH_VIDEO_GENRES, VIDEO_GENRES_ALL);
        matcher.addURI(authority, MediaContract.PATH_HOSTS + "/*/" +
                MediaContract.PATH_VIDEO_GENRES, VIDEO_GENRES_LIST);
        matcher.addURI(authority, MediaContract.PATH_HOSTS + "/*/" +
                MediaContract.PATH_VIDEO_GENRES + "/*", VIDEO_GENRES_ID);
        matcher.addURI(authority, MediaContract.PATH_HOSTS + "/*/" +
                MediaContract.PATH_VIDEO_GENRES + "/*/" +
                MediaContract.PATH_MOVIES, VIDEO_GENRE_MOVIES_LIST);
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case VIDEO_GENRES_ALL:
            case VIDEO_GENRES_LIST:
            case MOVIES_GENRES_LIST:
                return MediaContract.VideoGenres.CONTENT_TYPE;
            case VIDEO_GENRES_ID:
                return MediaContract.VideoGenres.CONTENT_ITEM_TYPE;
            ...
            case MOVIES_GENRES_ALL:
                return MediaContract.MovieGenres.CONTENT_TYPE;
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (match) {
            ...
            case VIDEO_GENRES_ALL: {
                table = MediaDatabase.Tables.VIDEO_GENRES;
                break;
            }
            case ALBUM_GENRES_ALL: {
            ...
            case MOVIES_GENRES_ALL: {
                table = MediaDatabase.Tables.MOVIE_GENRES;
                break;
            }
            case ALBUM_ARTISTS_ALL: {
    ...
    private SelectionBuilder buildQuerySelection(Uri uri, int match) {
        ...
        switch (match) {
            ...
            case VIDEO_GENRES_ALL: {
                return builder.table(MediaDatabase.Tables.VIDEO_GENRES);
            }
            case VIDEO_GENRES_LIST: {
                final String hostId = MediaContract.Hosts.getHostId(uri);
                return builder.table(MediaDatabase.Tables.VIDEO_GENRES)
                        .where(MediaContract.VideoGenres.HOST_ID + "=?", hostId);
            }
            case VIDEO_GENRES_ID: {
                final String hostId = MediaContract.Hosts.getHostId(uri);
                final String videoGenreId = MediaContract.VideoGenres.getVideoGenreId(uri);
                return builder.table(MediaDatabase.Tables.VIDEO_GENRES)
                        .where(MediaContract.VideoGenres.HOST_ID + "=?", hostId)
                        .where(MediaContract.VideoGenres.GENREID + "=?", videoGenreId);
            }
            case ALBUM_ARTISTS_ALL: {
            ...
            case MOVIES_GENRES_ALL: {
                return builder.table(MediaDatabase.Tables.MOVIE_GENRES);
            }
            case ARTIST_ALBUMS_LIST: {
                // Albums for Artists
                final String hostId = MediaContract.Hosts.getHostId(uri);
            ...
            case MOVIES_GENRES_LIST: {
                ...
                final String hostId = MediaContract.Hosts.getHostId(uri);
                final String movieId = MediaContract.Movies.getMovieId(uri);
                return builder.table(MediaDatabase.Tables.GENRES_FOR_MOVIE_JOIN)
                        .mapToTable(MediaContract.VideoGenres._ID, MediaDatabase.Tables.VIDEO_GENRES)
                        .mapToTable(MediaContract.VideoGenres.HOST_ID, MediaDatabase.Tables.VIDEO_GENRES)
                        .mapToTable(MediaContract.VideoGenres.GENREID, MediaDatabase.Tables.VIDEO_GENRES)
                        .mapToTable(MediaContract.MovieGenres.MOVIE_ID, MediaDatabase.Tables.MOVIE_GENRES)
                        .where(Qualified.MOVIE_GENRES_HOST_ID + "=?", hostId)
                        .where(Qualified.MOVIE_GENRES_GENREID + "=?", movieId);
            }
            case AUDIO_GENRE_ALBUMS_LIST: {
                // Album for a Genre
                final String hostId = MediaContract.Hosts.getHostId(uri);
            ...
            case VIDEO_GENRE_MOVIES_LIST: {
                // Album for a Genre
                final String hostId = MediaContract.Hosts.getHostId(uri);
                final String genreId = MediaContract.VideoGenres.getVideoGenreId(uri);
                return builder.table(MediaDatabase.Tables.MOVIES_FOR_GENRE_JOIN)
                        .mapToTable(MediaContract.Movies._ID, MediaDatabase.Tables.MOVIES)
                        .mapToTable(MediaContract.Movies.HOST_ID, MediaDatabase.Tables.MOVIES)
                        .mapToTable(MediaContract.Movies.MOVIEID, MediaDatabase.Tables.MOVIES)
                        .mapToTable(MediaContract.VideoGenres.GENREID, MediaDatabase.Tables.MOVIE_GENRES)
                        .where(Qualified.MOVIE_GENRES_HOST_ID + "=?", hostId)
                        .where(Qualified.MOVIE_GENRES_GENREID + "=?", genreId);
            }
    ...
    private interface Qualified {
        ...
        String MOVIE_GENRES_HOST_ID =
                MediaDatabase.Tables.MOVIE_GENRES + "." + MediaContract.MovieGenres.HOST_ID;
        String MOVIE_GENRES_GENREID =
                MediaDatabase.Tables.MOVIE_GENRES + "." + MediaContract.MovieGenres.GENREID;
