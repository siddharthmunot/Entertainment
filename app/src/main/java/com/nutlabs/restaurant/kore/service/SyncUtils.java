...
public class SyncUtils {
    ...
    /**
     * Returns {@link android.content.ContentValues} from a {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.DetailsMovie} movie
     * @param hostId Host id for this movie
     * @param movie {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.DetailsMovie}
    ...
    public static ContentValues contentValuesFromMovie(int hostId, VideoType.DetailsMovie movie) {
        ...
        movieValues.put(MediaContract.MoviesColumns.TAG,Utils.listStringConcat(movie.tag, LIST_DELIMETER));
        return movieValues;
    }

    /**
     * Returns {@link android.content.ContentValues} from a {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.Cast} movie cast
     * @param hostId Host id for this movie
     * @param cast {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.Cast}
     ...
     * @param tvshow {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.DetailsTVShow}
     ...
     * @param season {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.DetailsSeason}
    ...
    /**
     * Returns {@link android.content.ContentValues} from a {@link com.nutlabs.restaurant.kore.jsonrpc.type.AudioType.DetailsArtist} artist
     * @param hostId Host id for this movie
     * @param artist {@link com.nutlabs.restaurant.kore.jsonrpc.type.AudioType.DetailsArtist}
     ...
     * @return {@link android.content.ContentValues} with the genre values
     */
    public static ContentValues contentValuesFromVideoGenre(int hostId, LibraryType.DetailsGenre genre) {
        ContentValues castValues = new ContentValues();
        castValues.put(MediaContract.VideoGenres.HOST_ID, hostId);
        castValues.put(MediaContract.VideoGenres.GENREID, genre.genreid);
        castValues.put(MediaContract.VideoGenres.TITLE, genre.title);
        castValues.put(MediaContract.VideoGenres.THUMBNAIL, genre.thumbnail);
     ...
     * @param musicVideo {@link com.nutlabs.restaurant.kore.jsonrpc.type.VideoType.DetailsMusicVideo}
