...
import com.nutlabs.restaurant.kore.service.SyncUtils;
...
abstract public class AbstractDetailsFragment extends Fragment
    ...
    /**
     * Should return {@link com.nutlabs.restaurant.kore.service.LibrarySyncService} SyncType that
     * this fragment initiates
     * @return {@link com.nutlabs.restaurant.kore.service.LibrarySyncService} SyncType
     */
    abstract protected String getSyncType();

    /**
     * Should return the {@link com.nutlabs.restaurant.kore.service.LibrarySyncService} syncID if this fragment
     * synchronizes a single item. The itemId that should be synced must returned by {@link #getSyncItemID()}
     * @return {@link com.nutlabs.restaurant.kore.service.LibrarySyncService} SyncID
     */
