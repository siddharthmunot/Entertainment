 ...
 */
public class AnimatedMoviesActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   navigationDrawerFragment = (NavigationDrawerFragment) getSupportFragmentManager()
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_ANIMATEDMOVIE);
...
//        }
    ...
    private void setupActionBar(String movieTitle) {
        ...
        if (movieTitle != null) {
            ...
            actionBar.setTitle(R.string.animated_movies);
        }
    }
    ...
    public void onVideoGenreSelected(int genreId, String genreTitle) {
        ...
        MovieListFragmentFinal movieListFragment = MovieListFragmentFinal.newInstanceForGenre(genreId,genreTitle, SharedConstants.MOVIE_TAG_ANIMATEDMOVIE);
        getSupportFragmentManager()
                .beginTransaction()
