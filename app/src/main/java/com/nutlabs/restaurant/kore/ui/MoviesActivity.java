...
public class MoviesActivity extends BaseActivity
        implements MovieListFragment.OnMovieSelectedListener,VideoGenresListFragment.OnVideoGenreSelectedListener {
...
//        }
    ...
    public void onVideoGenreSelected(int genreId, String genreTitle) {
        ...
        MovieListFragment movieListFragment = MovieListFragment.newInstanceForGenre(genreId,genreTitle, SharedConstants.MOVIE_TAG_SHORTMOVIES);
        getSupportFragmentManager()
                .beginTransaction()
