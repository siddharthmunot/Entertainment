 ...
 */
public class NewAdditionActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_NEW_ADDITION);
...
//        }
    ...
    private void setupActionBar(String movieTitle) {
        ...
        if (movieTitle != null) {
            ...
            actionBar.setTitle(R.string.short_movies);
        }
    }
    ...
    public void onVideoGenreSelected(int genreId, String genreTitle) {
        ...
        MovieListFragmentFinal movieListFragment = MovieListFragmentFinal.newInstanceForGenre(genreId,genreTitle, SharedConstants.MOVIE_TAG_NEW_ADDITION);
        getSupportFragmentManager()
                .beginTransaction()
