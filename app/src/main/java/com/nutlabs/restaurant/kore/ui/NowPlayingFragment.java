...
import com.nutlabs.restaurant.kore.jsonrpc.method.Addons;
import com.nutlabs.restaurant.kore.jsonrpc.method.Application;
...
import com.nutlabs.restaurant.kore.jsonrpc.type.ApplicationType;
...
//        mediaPanel.setClipToPadding(false);
     ...
     * @param getItemResult Return from method {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetItem}
     */
    private void setNowPlayingInfo(PlayerType.PropertyValue getPropertiesResult,
        ...
        if (getPropertiesResult.repeat.equals(PlayerType.Repeat.OFF)) {
            repeatButton.setImageResource(styledAttributes.getResourceId(1, R.mipmap.ic_repeat_white_24dp));
            repeatButton.clearColorFilter();
        } else if (getPropertiesResult.repeat.equals(PlayerType.Repeat.ONE)) {
            repeatButton.setImageResource(styledAttributes.getResourceId(2, R.mipmap.ic_repeat_one_white_24dp));
