...
import com.nutlabs.restaurant.kore.eventclient.ButtonCodes;
import com.nutlabs.restaurant.kore.eventclient.EventServerConnection;
import com.nutlabs.restaurant.kore.eventclient.Packet;
import com.nutlabs.restaurant.kore.eventclient.PacketBUTTON;
import com.nutlabs.restaurant.kore.host.HostConnectionObserver;
...
import com.nutlabs.restaurant.kore.jsonrpc.method.GUI;
import com.nutlabs.restaurant.kore.jsonrpc.method.Input;
import com.nutlabs.restaurant.kore.jsonrpc.method.Player;
import com.nutlabs.restaurant.kore.jsonrpc.type.GlobalType;
...
import com.nutlabs.restaurant.kore.utils.RepeatListener;
...
public class RemoteFragment extends Fragment
    ...
    @InjectView(R.id.rewind)
    ImageButton rewindButton;
    @InjectView(R.id.fast_forward)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fastForwardIcon = styledAttributes.getResourceId(0, R.mipmap.ic_fast_forward_white_24dp);
        rewindIcon = styledAttributes.getResourceId(1, R.mipmap.ic_fast_rewind_white_24dp);
        skipNextIcon = styledAttributes.getResourceId(2, R.mipmap.ic_skip_next_white_24dp);
        skipPreviousIcon = styledAttributes.getResourceId(3, R.mipmap.ic_skip_previous_white_24dp);
        skipPreviousIcon = styledAttributes.getResourceId(3, R.mipmap.ic_skip_previous_white_24dp);
...
//                R.attr.remoteBackgroundColorFilter});
        ...
        int backgroundResourceId = R.mipmap.remote_background_square_black;
...
//    }
     ...
     * @param nowPlaying Return from method {@link com.nutlabs.restaurant.kore.jsonrpc.method.Player.GetItem}
     */
