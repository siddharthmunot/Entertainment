 ...
 */
public class ShortMoviesActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* navigationDrawerFragment = (NavigationDrawerFragment) getSupportFragmentManager()
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_SHORTMOVIES);
...
//        }
    ...
    public void onVideoGenreSelected(int genreId, String genreTitle) {
        ...
        MovieListFragmentFinal movieListFragment = MovieListFragmentFinal.newInstanceForGenre(genreId,genreTitle, SharedConstants.MOVIE_TAG_SHORTMOVIES);
        getSupportFragmentManager()
                .beginTransaction()
