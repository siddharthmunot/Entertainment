 ...
 */
public class TedTalksActivity extends BaseActivity
...
*/
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_TEDTALKS);
...
//        }
    ...
    private void setupActionBar(String movieTitle) {
        ...
        if (movieTitle != null) {
            ...
            actionBar.setTitle(R.string.ted_talks);
        }
    }
    ...
    public void onVideoGenreSelected(int genreId, String genreTitle) {
        ...
        MovieListFragmentFinal movieListFragment = MovieListFragmentFinal.newInstanceForGenre(genreId,genreTitle, SharedConstants.MOVIE_TAG_TEDTALKS);
        getSupportFragmentManager()
                .beginTransaction()
