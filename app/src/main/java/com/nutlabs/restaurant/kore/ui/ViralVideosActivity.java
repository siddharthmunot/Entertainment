 ...
 */
public class ViralVideosActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_VIRAL_VIDEOS);
...
//        }
    ...
    public void onVideoGenreSelected(int genreId, String genreTitle) {
        ...
        MovieListFragmentFinal movieListFragment = MovieListFragmentFinal.newInstanceForGenre(genreId,genreTitle, SharedConstants.MOVIE_TAG_VIRAL_VIDEOS);
        getSupportFragmentManager()
                .beginTransaction()
