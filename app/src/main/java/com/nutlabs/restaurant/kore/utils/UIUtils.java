 ...
 */
package com.nutlabs.restaurant.kore.utils;
...
import com.nutlabs.restaurant.kore.ui.RemoteActivity;
...
//            avatarColorsIdx = randomGenerator.nextInt(characterAvatarColors.length());
    ...
    static int iconPauseResId = R.mipmap.ic_pause_white_24dp,
            iconPlayResId = R.mipmap.ic_play_arrow_white_24dp;
    /**
    ...
    public static void setPlayPauseButtonIcon(Context context, ImageView view, int speed) {
        ...
        if (!playPauseIconsLoaded) {
            ...
            iconPauseResId = styledAttributes.getResourceId(0, R.mipmap.ic_pause_white_24dp);
            iconPlayResId = styledAttributes.getResourceId(1, R.mipmap.ic_play_arrow_white_24dp);
